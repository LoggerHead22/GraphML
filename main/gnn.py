...
class GNN(nn.Module):
    ...
    def __init__(self, num_tasks = 1, num_layers = 5, emb_dim = 300, gnn_type = 'gin',
        ...
        self.num_layers = num_layers # Число итераций T 
        self.drop_ratio = drop_ratio
        self.JK = JK
        self.emb_dim = emb_dim # hidden_state size 
        self.num_tasks = num_tasks 
        self.graph_pooling = graph_pooling #readout
        ...
        if virtual_node:
            ...
            self.gnn_node = GNN_node(num_layers, emb_dim, JK = JK, drop_ratio = drop_ratio,
                                     residual = residual, gnn_type = gnn_type, num_iter = num_iter)
